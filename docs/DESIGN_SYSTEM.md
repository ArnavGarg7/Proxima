...
Design language, tokens, and page-level UI specifications for the Proxima
frontend. The colour, typography, and motion tokens defined here are the source
of truth for `frontend/tailwind.config.ts` and the shared component library in
